    ...
    sections: [
      {
        type: "added",
        items: [
          "Studio API Client: Full-featured client for data access (shared/studio-client.ts)",
          "Segment Metadata Fetching: Total record counts from Studio API",
          "Paginated Data Retrieval: Configurable page size for large datasets",
          "CSV Export: Proper escaping and formatting for all 74 enriched fields",
          "Retry Logic: Exponential backoff for failed API requests",
          "Error Handling: 404, 429, 500 response handling",
          "Studio tRPC Router: Server-side API integration (server/routers/studio.ts)",
          "getSegmentData Procedure: Fetch paginated audience records",
          "linkSegment Procedure: Create audience-to-segment mapping",
          "getLinkedSegment Procedure: Retrieve mapping by audience ID",
          "exportSegmentCSV Procedure: Generate CSV export of full dataset",
          "Segment Mapping Service: Database operations (server/services/segment-mapping.ts)",
          "Database Schema: audience_segments table for mapping storage",
          "Link Segment Dialog: Step-by-step UI for connecting Studio segments",
          "Segment ID Validation: UUID format validation with real-time feedback",
          "Data Access Section: Shows segment linking status on audience detail page",
          "Segment Linked Badge: Green badge when segment is connected",
          "Audience Data Table: Displays all 74 enriched fields from Studio API",
          "Pagination Controls: Previous/Next navigation for large datasets",
          "Record Count Display: Shows current page range (e.g., 'Showing 1 to 10 of 500,000')",
          "View Data Button: Fetches first page of records from Studio",
          "Refresh Data: Updates data table with latest records",
          "Export CSV Button: Downloads full dataset with automatic browser download",
          "Loading Spinners: Visual feedback during data fetch and export",
          "Documentation: AUDIENCELAB_ARCHITECTURE.md - Complete two-API system explanation",
          "Documentation: STUDIO_API_GUIDE.md - Studio API integration guide with examples",
          "Documentation: HYBRID_IMPLEMENTATION_GUIDE.md - Implementation roadmap",
        ],
      },
      {
        type: "changed",
        items: [
          ...
          "Removed 'Not Available' placeholders for audience data",
          "Added dynamic data fetching from Studio API",
          "Improved user experience with clear status indicators",
          "Better error handling and loading states",
          "Navigation: Improved consistency with Back button pattern",
        ],
      },
    ],
  },
